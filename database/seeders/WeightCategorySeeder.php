...
class WeightCategorySeeder extends Seeder
{
    ...
    {
        DB::table('weight_categories')->where('gender', 'male')->update(['gender' => 'Male']);
        DB::table('weight_categories')->where('gender', 'female')->update(['gender' => 'Female']);
        ...
        $weightCategories = [
            ...
            ['name' => '-66', 'gender' => 'Male', 'min_weight' => 60, 'max_weight' => 66, 'age_category' => 'Juniors 16-17'],
            ['name' => '-73', 'gender' => 'Male', 'min_weight' => 66, 'max_weight' => 73, 'age_category' => 'Juniors 16-17'],
            ['name' => '-81', 'gender' => 'Male', 'min_weight' => 73, 'max_weight' => 81, 'age_category' => 'Juniors 16-17'],
            ['name' => '-90', 'gender' => 'Male', 'min_weight' => 81, 'max_weight' => 90, 'age_category' => 'Juniors 16-17'],
            ...
            ['name' => '-44', 'gender' => 'Female', 'min_weight' => 0, 'max_weight' => 44, 'age_category' => 'Senior 18+'],
            ['name' => '-48', 'gender' => 'Female', 'min_weight' => 44, 'max_weight' => 48, 'age_category' => 'Senior 18+'],
            ['name' => '-52', 'gender' => 'Female', 'min_weight' => 48, 'max_weight' => 52, 'age_category' => 'Senior 18+'],
            ['name' => '-57', 'gender' => 'Female', 'min_weight' => 52, 'max_weight' => 57, 'age_category' => 'Senior 18+'],
            ['name' => '-63', 'gender' => 'Female', 'min_weight' => 57, 'max_weight' => 63, 'age_category' => 'Senior 18+'],
            ['name' => '-70', 'gender' => 'Female', 'min_weight' => 63, 'max_weight' => 70, 'age_category' => 'Senior 18+'],
            ['name' => '-78', 'gender' => 'Female', 'min_weight' => 70, 'max_weight' => 78, 'age_category' => 'Senior 18+'],
            ['name' => '-87', 'gender' => 'Female', 'min_weight' => 78, 'max_weight' => 87, 'age_category' => 'Senior 18+'],
            ['name' => '+87', 'gender' => 'Female', 'min_weight' => 87, 'max_weight' => 999, 'age_category' => 'Senior 18+'],
            ['name' => '-60', 'gender' => 'Male', 'min_weight' => 0, 'max_weight' => 60, 'age_category' => 'Senior 18+'],
            ['name' => '-66', 'gender' => 'Male', 'min_weight' => 60, 'max_weight' => 66, 'age_category' => 'Senior 18+'],
            ['name' => '-73', 'gender' => 'Male', 'min_weight' => 66, 'max_weight' => 73, 'age_category' => 'Senior 18+'],
            ['name' => '-81', 'gender' => 'Male', 'min_weight' => 73, 'max_weight' => 81, 'age_category' => 'Senior 18+'],
            ['name' => '-90', 'gender' => 'Male', 'min_weight' => 81, 'max_weight' => 90, 'age_category' => 'Senior 18+'],
            ['name' => '-100', 'gender' => 'Male', 'min_weight' => 90, 'max_weight' => 100, 'age_category' => 'Senior 18+'],
            ['name' => '+100', 'gender' => 'Male', 'min_weight' => 100, 'max_weight' => 999, 'age_category' => 'Senior 18+'],
        ];
