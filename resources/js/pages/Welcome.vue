...
<template>
    ...
    >
        ...
        >
            <nav class="flex items-center justify-end gap-4">
                <Link
                    ...
                    :href="dashboard()"
                    class="inline-block rounded-sm border border-border px-5 py-1.5 text-sm leading-normal text-foreground hover:border-accent"
                >
                    Dashboard
                </Link>
                <template v-else>
        ...
        >
            ...
            >
                <div
                    class="flex-1 rounded-br-lg rounded-bl-lg bg-card p-6 pb-12 text-[13px] leading-5 shadow-sm lg:rounded-tl-lg lg:rounded-br-none lg:p-20 text-foreground"
                >
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        <li
                            class="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l border-border"
                        >
                            <span
                ...
                <div
                    class="relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg bg-primary/10 lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-109.5 lg:rounded-t-none lg:rounded-r-lg"
                >
                    <svg
