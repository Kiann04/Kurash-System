...
<div class="min-h-screen bg-[#050a14] text-white font-sans selection:bg-yellow-500 selection:text-black">
    ...
    <main class="max-w-7xl mx-auto px-4 py-16 relative">
            ...
            <div class="flex flex-col items-center text-center gap-6 border-b border-slate-800 pb-12">
                <div class="max-w-4xl mx-auto flex flex-col items-center">
                    <div class="flex items-center gap-3 mb-4 justify-center">
                        ...
                        <span class="text-yellow-500 font-black uppercase tracking-[0.3em] text-[10px]">Official Database</span>
                        <div class="h-px w-8 bg-yellow-500"></div>
                    </div>
                    <h1 class="text-5xl md:text-7xl font-serif font-bold text-white mb-6 leading-tight tracking-tight uppercase">
                        <span class="text-yellow-500 italic">Athletes</span>
                    </h1>
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-6 mb-12 bg-[#0f172a]/50 p-2 rounded-2xl border border-white/5 backdrop-blur-sm relative z-10">
            ...
            <div class="flex items-center gap-3 w-full md:w-auto">
                <div class="text-[10px] font-black text-slate-500 uppercase tracking-widest hidden lg:block mr-4">
                    Total: <span class="text-white">{{ filteredPlayers.length }}</span>
                </div>
        ...
        <!-- Grid -->
        <div v-if="filteredPlayers.length === 0" class="py-24 text-center border border-dashed border-slate-800 rounded-5xl">
            <p class="text-slate-500 italic text-xl">No athletes found matching your criteria.</p>
        </div>
    ...
    <!-- Footer -->
    <footer class="border-t border-white/10 bg-[#050a14] py-12 relative z-50">
