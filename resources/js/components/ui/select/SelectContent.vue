  ...
  <SelectPortal>
    <SelectContent
      ...
      :class="cn(
        ...
        position === 'popper' &&
          'data-[side=bottom]:translate-y-1 data-[side=left]:-translate-x-1 data-[side=right]:translate-x-1 data-[side=top]:-translate-y-1 w-(--radix-select-trigger-width) min-w-(--radix-select-trigger-width)',
        props.class,
      )"
    >
